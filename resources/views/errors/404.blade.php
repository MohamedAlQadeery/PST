...
<svg xmlns="http://www.w3.org/2000/svg" id="robot-error" viewBox="0 0 260 118.9">
      <defs>
       ...
       <text id="text-s" class="error-text" y="106"> 404</text>
        ...
        <path class="alarm" fill="blue" d="M120.9 19.6V9.1c0-5 4.1-9.1 9.1-9.1h0c5 0 9.1 4.1 9.1 9.1v10.6" />
      ...
      <g id="robot">
        <g id="eye-wrap">
          ...
          <ellipse id="white-eye" fill="#2b2b2b" cx="130" cy="40"  />
         </g>
...
<h2>Go <a target="_blank" href="{{route('site.home')}}">Home!</a></h2>
