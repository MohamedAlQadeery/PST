			...
			<tbody>
				...
				<tr>
                  ...
                  <td class="center">
                    ...
                    <td class="center">
                        <a href="{{route('user.products.edit',$product->id)}}" class="btn btn-gold">@lang('site.edit')</a>

                        <form action="{{route('user.products.destroy',$product->id)}}" method="post" style="display:inline"
                            onsubmit="return confirm('Are you sure you want to delete this user?');">
                          @csrf()
                          @method('DELETE')
                      <button  class="btn btn-danger"><i class="fa fa-trash"></i>@lang('site.delete')</button>
                      </form>
                         <a href="{{route('user.products.show',$product->id)}}" class="btn btn-info">@lang('site.show')</a>
                    </td>
