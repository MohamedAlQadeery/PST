...
<body class="page-body droid-arabic-kufi" data-url="https://demo.neontheme.com">
...
<div class="main-content">
    ...
    {{-- <footer class="main"> --}}
        {{-- <div class="pull-right"> --}}
         ...
         {{-- </div> --}}
        {{-- &copy; 2020 <strong>Neon</strong> Admin Theme by <a href="https://laborator.co/" target="_blank">Laborator</a> </footer> --}}
    <!-- End Footer -->
