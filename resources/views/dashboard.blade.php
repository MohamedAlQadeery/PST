...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-sm-3 col-xs-6">
            ...
            <div class="tile-stats tile-aqua">
                ...
                <p>@lang('site.users_count_desc')</p>
            </div>
        ...
        <div class="col-sm-3 col-xs-6">
            ...
            <div class="tile-stats tile-red">
                ...
                <div class="num" data-start="0" data-end="{{$card2}}" data-postfix="" data-duration="1500" data-delay="0">0</div>

                <h3>@lang('site.products')</h3>
                <p>@lang('site.products_count_desc')</p>
            </div>
        ...
        <div class="col-sm-3 col-xs-6">
            ...
            <div class="tile-stats tile-green">
                ...
                <div class="num" data-start="0" data-end="{{$card3}}" data-postfix="" data-duration="1500" data-delay="600">0</div>

                <h3>@lang('site.shopproducts_count')</h3>
                <p>@lang('site.shopproducts_count_desc')</p>
            </div>
        ...
        <div class="col-sm-3 col-xs-6">
            ...
            <div class="tile-stats tile-blue">
                ...
                <h3>@lang('site.transaction')</h3>
                <p>@lang('site.transaction_count_desc')</p>
            </div>
    ...
    <div class="row">
            ...
            <div class="panel panel-primary panel-table">
                <div class="panel-heading">
                    <div class="panel-title">
                        <h3>@lang('site.providertopSolledProducts')</h3>
                        <span>@lang('site.providertopSolledProducts_desc')</span>
                    </div>
                ...
                <div class="panel-body">
                    <table class="table table-responsive no-margin">
                        ...
                        <tbody>
                            ...
                            @foreach ($providertopSolledProducts as $item)
                            <tr>
                                @if(auth()->user()->type==2)
                                <td>{{$item->name}}</td>
                                @else
        ...
        <div class="col-md-6">
            <div class="panel panel-primary panel-table">
                <div class="panel-heading">
                    <div class="panel-title">
                        <h3>@lang('site.sellerTopSolledProducts_panel')</h3>
                ...
                <div class="panel-body">
                    <table class="table table-responsive no-margin">
                        ...
                        <tbody>
                            ...
                            @foreach ($sellerTopSolledProducts as $item)
                            <tr>
                                @if(auth()->user()->type==2)
                                <td>{{$item->name}}</td>
                                @else
    ...
    <div class="row">
            ...
            <div class="panel panel-primary panel-table">
                <div class="panel-heading">
                    <div class="panel-title">
                        <h3>@lang('site.contactus')</h3>
                        <span>@lang('site.contactus_desc')</span>
                    </div>
                ...
                <div class="panel-body">
                    <table class="table table-responsive no-margin">
                        ...
                        <tbody>
                            ...
                            @foreach ($contactusMessages as $index=> $item)
                            <tr>
                                <td>{{++$index}}</td>
                                <td><a href="{{route('admin.contactus.show',$item->id)}}">{{$item->title}}</a></td>
                                <td><a href="{{route('profile.show',$item->user->id)}}">{{$item->user->first_name.' '.$item->user->last_name}}</a></td>
                                <td> <a href="{{route('profile.show',$item->user->id)}}">{{$item->user->email}}</a></td>
                                <td class="text-center">
                                    @if($item->read==1)
                                    <div class="label label-success">@lang('site.isRead')</div>
                                    @else
                                    <div class="label label-danger">@lang('site.unread')</div>
                                    @endif
